...
export default function ReceiveOrdersHelpPage() {
  ...
  return (
    <main className="min-h-screen bg-black text-white">
      ...
      <div className="flex items-center gap-4 p-4">
        ...
        <h1 className="text-2xl font-semibold">Receive Orders</h1>
      </div>
      ...
      <section className="px-5 mt-8">
        <div className="bg-zinc-900 rounded-2xl p-5">
          ...
          <p className="text-gray-400 mt-2">⏱ 2–5 Minutes per Order</p>
        </div>
      </section>
